...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('paypal_nvp', (
            ...
            ('transactionid', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('paymentstatus', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
        ...
        db.send_create_signal('paypal', ['PayPalNVP'])
    ...
    models = {
        ...
        'paypal.paypalnvp': {
            ...
            'paymentstatus': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
